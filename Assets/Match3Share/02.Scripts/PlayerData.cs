...
public class SaveDataClass
{
    ...
    public int _primiumTicketReceiveLevel;
...
public class PlayerData : Singleton<PlayerData>
{
    ...
    private int _primiumTicketReceiveLevel;
    ...
    public int PrimiumTicketReceiveLevel
    {
        get => _primiumTicketReceiveLevel;
        set
        {
            _primiumTicketReceiveLevel = value;
            SaveData("PrimiumTicketReceiveLevel", _primiumTicketReceiveLevel);
        }
    }
...
*/
        ...
        _primiumTicketReceiveLevel = LoadGameInt("PrimiumTicketReceiveLevel");
    ...
    public void SaveAllData()
    {
        ...
        SaveGameInt("PrimiumTicketReceiveLevel", _primiumTicketReceiveLevel);
    ...
    public string ToJsonData()
    {
        ...
        data._primiumTicketReceiveLevel = _primiumTicketReceiveLevel;
...
//_pickDayCheck = data._pickDayCheck;
        ...
        _primiumTicketReceiveLevel = data._primiumTicketReceiveLevel;
